...
export function Home() {
    return( <div className="mx-auto h-screen sm:flex content-center ">
        ...
        <main className="flex flex-col flex-1 justify-center p-8 items-center ">
                <button
                    ...
                    className="sm:w-1/2 w-full py-2 flex items-center font-medium justify-center rounded-md bg-red-500 hover:bg-red-600 text-white">
                    <img className="pr-2 sm:w-1/12" src={googleIconImage} alt="Logo de Google"/>  Crea tu sala con Google
                </button>
